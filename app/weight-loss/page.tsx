          ...
          <div className="max-w-[1200px] mx-auto">
            ...
            <div className="block lg:hidden">
              ...
              <div className="relative mb-6">
                <div className="flex justify-center items-center gap-2 px-2">
                  <div className="w-[90px] h-[120px] rounded-[12px] overflow-hidden shadow-lg border-3 border-white flex-shrink-0">
                    <Image
                  ...
                  <div className="w-[100px] h-[130px] rounded-[12px] overflow-hidden shadow-lg border-3 border-white flex-shrink-0 z-10">
                    <Image
                  ...
                  <div className="relative w-[90px] h-[120px] rounded-[12px] overflow-hidden shadow-lg border-3 border-white flex-shrink-0">
                    <Image
            ...
            <div className="hidden lg:flex gap-10 items-start">
              ...
              <div className="flex-1 relative flex justify-center items-center min-h-[500px]">
                ...
                <div className="absolute top-[10px] left-[5%] w-[200px] h-[260px] rounded-[20px] overflow-hidden shadow-xl rotate-[-6deg] border-4 border-white z-10">
                  <Image
                    src="/api/images/69b7c6eea14dfc9fbf5ad5d6"
                    alt="Transformation"
                    fill
                ...
                <div className="absolute top-[30px] right-[5%] w-[180px] h-[230px] rounded-[20px] overflow-hidden shadow-xl rotate-[4deg] border-4 border-white z-20">
                  <Image
                    src="/api/images/69b7c716a14dfc9fbf5ad6cb"
                    alt="Transformation"
                    fill
                ...
                <div className="absolute bottom-[20px] left-[20%] w-[200px] h-[270px] rounded-[20px] overflow-hidden shadow-xl rotate-[-2deg] border-4 border-white z-30">
                  <Image
                    src="/api/images/69b7c6f1a14dfc9fbf5ad5e8"
                    alt="Transformation"
                    fill
