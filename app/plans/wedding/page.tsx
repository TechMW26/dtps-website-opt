    ...
    <main className={`bg-white ${epilogue.className}`}>
      ...
      <section className="wedding-hero-wrapper">
        <div className="wedding-hero-section">
          <Image
            src="/api/images/69b7c727a14dfc9fbf5ad706"
            alt="Wedding couple"
            fill
            priority
...
<Image
src="/api/images/69b7c70fa14dfc9fbf5ad6a1"
...
<img src="/api/images/69b7c6ffa14dfc9fbf5ad637" className="w-7" loading="lazy" decoding="async" alt="Detox"/>
</div>
...
<div className="w-[70px] h-[70px] bg-white rounded-full flex items-center justify-center border-4 border-white">
<img src="/api/images/69b7c70ea14dfc9fbf5ad691" className="w-7" loading="lazy" decoding="async" alt="Anti-Inflammatory"/>
</div>
...
<div className="w-[70px] h-[70px] bg-white rounded-full flex items-center justify-center border-4 border-white">
<img src="/api/images/69b7c709a14dfc9fbf5ad677" className="w-7" loading="lazy" decoding="async" alt="Fat Burning"/>
</div>
...
<div className="w-[70px] h-[70px] bg-white rounded-full flex items-center justify-center border-4 border-white">
<img src="/api/images/69b7c70fa14dfc9fbf5ad69f" className="w-7" loading="lazy" decoding="async" alt="Metabolic"/>
</div>
...
<div className="w-[70px] h-[70px] bg-white rounded-full flex items-center justify-center border-4 border-white">
<img src="/api/images/69b7c70ea14dfc9fbf5ad699" className="w-7" loading="lazy" decoding="async" alt="Maintenance"/>
</div>
...
<Image
src="/api/images/69b7c709a14dfc9fbf5ad671"
alt="Fad Diet"
width={40}
height={40}
loading="lazy"
      ...
      <div className="hidden md:flex items-start justify-center gap-16 mb-14">
        <div className="flex flex-col items-center gap-4">
          <div className="w-[90px] h-[90px] bg-white rounded-full flex items-center justify-center shadow-lg">
            <Image src="/api/images/69b7c66fa14dfc9fbf5ad4f6" alt="Fully Customised Diet Plan" width={50} height={50} loading="lazy" />
          </div>
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="w-[90px] h-[90px] bg-white rounded-full flex items-center justify-center shadow-lg">
            <Image src="/api/images/69b7c6e6a14dfc9fbf5ad594" alt="Shaadi-Ready Custom Diet Plan" width={50} height={50} loading="lazy" />
          </div>
          <p className="text-white text-base font-medium text-center leading-snug">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="w-[90px] h-[90px] bg-white rounded-full flex items-center justify-center shadow-lg">
            <Image src="/api/images/69b7c6b3a14dfc9fbf5ad560" alt="Medical-Aware Personalised Plan" width={50} height={50} loading="lazy" />
          </div>
          <p className="text-white text-base font-medium text-center leading-snug">
      ...
      <div className="flex md:hidden flex-col gap-5 mb-8 max-w-[260px] mx-auto">
        <div className="flex items-center gap-4">
          <div className="w-[56px] h-[56px] min-w-[56px] bg-white rounded-full flex items-center justify-center shadow-lg">
            <Image src="/api/images/69b7c66fa14dfc9fbf5ad4f6" alt="Fully Customised Diet Plan" width={32} height={32} loading="lazy" />
          </div>
        ...
        <div className="flex items-center gap-4">
          <div className="w-[56px] h-[56px] min-w-[56px] bg-white rounded-full flex items-center justify-center shadow-lg">
            <Image src="/api/images/69b7c6e6a14dfc9fbf5ad594" alt="Shaadi-Ready Custom Diet Plan" width={32} height={32} loading="lazy" />
          </div>
          <p className="text-white text-sm font-medium leading-snug">
            Shaadi-Ready<br />Custom Diet Plan
          </p>
        ...
        <div className="flex items-center gap-4">
          <div className="w-[56px] h-[56px] min-w-[56px] bg-white rounded-full flex items-center justify-center shadow-lg">
            <Image src="/api/images/69b7c6b3a14dfc9fbf5ad560" alt="Medical-Aware Personalised Plan" width={32} height={32} loading="lazy" />
          </div>
          <p className="text-white text-sm font-medium leading-snug">
            Medical-Aware<br />Personalised Plan
          </p>
    ...
    <div className="hidden md:flex flex-col gap-5 max-w-[850px] mx-auto">
      <div className="bg-[#4E0101] rounded-2xl flex items-center gap-6 px-8 py-6">
        <div className="w-[80px] h-[80px] min-w-[80px] bg-white rounded-xl flex items-center justify-center">
          <Image src="/api/images/69b7c716a14dfc9fbf5ad6c9" alt="Personalised" width={48} height={48} loading="lazy" />
        </div>
      ...
      <div className="bg-[#4E0101] rounded-2xl flex items-center gap-6 px-8 py-6">
        <div className="w-[80px] h-[80px] min-w-[80px] bg-white rounded-xl flex items-center justify-center">
          <Image src="/api/images/69b7c70fa14dfc9fbf5ad69b" alt="Medical" width={48} height={48} loading="lazy" />
        </div>
        <p className="text-white text-base md:text-lg font-medium leading-snug">
      ...
      <div className="bg-[#4E0101] rounded-2xl flex items-center gap-6 px-8 py-6">
        <div className="w-[80px] h-[80px] min-w-[80px] bg-white rounded-xl flex items-center justify-center">
          <Image src="/api/images/69b7c6e9a14dfc9fbf5ad5a3" alt="No supplements" width={48} height={48} loading="lazy" />
        </div>
        <p className="text-white text-base md:text-lg font-medium leading-snug">
      ...
      <div className="bg-[#4E0101] rounded-2xl flex items-center gap-6 px-8 py-6">
        <div className="w-[80px] h-[80px] min-w-[80px] bg-white rounded-xl flex items-center justify-center">
          <Image src="/api/images/69b7c66fa14dfc9fbf5ad4fa" alt="No heavy workouts" width={48} height={48} loading="lazy" />
        </div>
        <p className="text-white text-base md:text-lg font-medium leading-snug">
    ...
    <div className="md:hidden flex flex-col gap-4">
      <div className="bg-[#4E0101] rounded-2xl flex items-center gap-4 px-5 py-5">
        <div className="w-[60px] h-[60px] min-w-[60px] bg-white rounded-xl flex items-center justify-center">
          <Image src="/api/images/69b7c716a14dfc9fbf5ad6c9" alt="Personalised" width={36} height={36} loading="lazy" />
        </div>
        <p className="text-white text-sm font-medium leading-snug">
      ...
      <div className="bg-[#4E0101] rounded-2xl flex items-center gap-4 px-5 py-5">
        <div className="w-[60px] h-[60px] min-w-[60px] bg-white rounded-xl flex items-center justify-center">
          <Image src="/api/images/69b7c70fa14dfc9fbf5ad69b" alt="Medical" width={36} height={36} loading="lazy" />
        </div>
        <p className="text-white text-sm font-medium leading-snug">
      ...
      <div className="bg-[#4E0101] rounded-2xl flex items-center gap-4 px-5 py-5">
        <div className="w-[60px] h-[60px] min-w-[60px] bg-white rounded-xl flex items-center justify-center">
          <Image src="/api/images/69b7c6e9a14dfc9fbf5ad5a3" alt="No supplements" width={36} height={36} loading="lazy" />
        </div>
        <p className="text-white text-sm font-medium leading-snug">
      ...
      <div className="bg-[#4E0101] rounded-2xl flex items-center gap-4 px-5 py-5">
        <div className="w-[60px] h-[60px] min-w-[60px] bg-white rounded-xl flex items-center justify-center">
          <Image src="/api/images/69b7c66fa14dfc9fbf5ad4fa" alt="No heavy workouts" width={36} height={36} loading="lazy" />
        </div>
        <p className="text-white text-sm font-medium leading-snug">
