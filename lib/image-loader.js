...
function imageLoader({ src, width, quality }) {
    ...
    // For non-ImageKit URLs, return the src directly.
    // With loader: 'custom', the /_next/image endpoint is disabled,
    // so local/public images must be served as-is from their path.
    return src;
}
