    ...
    >
      <div className="site-fill">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2">
          ...
          >
            {/* Responsive WebP – generated by scripts/optimize-public-images.cjs */}
            <img
              src="/girlthali-900.webp"
              srcSet="/girlthali-600.webp 600w, /girlthali-900.webp 900w, /girlthali-1400.webp 1400w"
